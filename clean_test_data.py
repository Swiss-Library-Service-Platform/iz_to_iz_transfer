...
# Config logs
config_log()
barcodes = pd.read_excel('model/test_data.xlsx', sheet_name=1, dtype=str)['Barcode'].dropna().str.strip("'")
src_data = pd.read_excel('model/test_data.xlsx', sheet_name='Holdings', dtype=str).dropna()[['IZ_MMS_id','Holding_id']]
